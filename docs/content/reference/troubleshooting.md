...
Most of these come down to network reality or how idigbio serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

idigbio rate-limits like any public site. idigbio already paces
...
Where a surface is gated, idigbio reads a cookie or token you supply
...
`idigbio`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what idigbio actually did
