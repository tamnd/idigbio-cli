...
// HTTP behaviour is covered in idigbio_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "idigbio://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("idigbio", "about")
	if err != nil || got.String() != "idigbio://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want idigbio://page/about", got.String(), err)
	}
}
